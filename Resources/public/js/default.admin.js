(function ($) {
	...
	var setBehaviors = function() {
		mediaList.delegate('.delete', 'click', onDeleteButtonClick);
		mediaList.delegate('.submit', 'click', onSubmitButtonClick);

		$('select.set-category').change(onAddNewCategorySelectChange);
		$('.btn-media-add-category .add').click(onAddNewCategoryClick);
		$('.btn-media-add-category .new').click(onAddNewCategoryBtnClick);
	};
